    ...
    <div className="card p-4">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          ...
          <input className="input" value={form.name} onChange={e => update('name', e.target.value)} placeholder="Ex: Bright Red of Étampes" />
        </div>
        <div>
          <label className="label">Variety</label>
          <input className="input" value={form.variety || ''} onChange={e => update('variety', e.target.value)} placeholder="Pumpkin, Butternut…" />
        </div>
        <div>
